...
| [semantix-ai](https://github.com/labrat-akhona/semantix-ai) | `all` | A semantic type system that validates LLM outputs against natural language intents using local NLI models with ~15ms latency and zero API cost. |
